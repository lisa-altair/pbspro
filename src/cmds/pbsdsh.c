...
int	    numnodes;
tm_task_id *tid;
tm_event_t 				event_obit;
tm_event_t 				event_spawn;
...
main(int argc, char *argv[], char *envp[])
{
	...
	event_spawn = TM_NULL_EVENT;
	event_obit = TM_NULL_EVENT;
	...
	if ((rc = tm_spawn_multi(argc-optind, argv+optind, NULL, node_select, stop-start, tid, &event_spawn)) != TM_SUCCESS) {
